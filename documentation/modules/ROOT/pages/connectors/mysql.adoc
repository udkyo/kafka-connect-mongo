...
When the MySQL connection is read-only, you can use the {link-prefix}:{link-signalling}#debezium-signaling-enabling-kafka-signaling-channel[kafka signaling channel] to send messages to Kafka topic.
